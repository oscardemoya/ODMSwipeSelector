...
#import "MCDSwipeView.h"

@interface MCDSwipeView ()
...
- (id)initWithCoder:(NSCoder *)aDecoder {
    ...
    if (self) {
        ...
        NSArray *horizontalConstraints = [NSLayoutConstraint constraintsWithVisualFormat:@"H:|-0-[trackView(self)]-0-|"
                                                                               options:NSLayoutFormatAlignAllCenterY
                                                                               metrics:nil
                                                                                   views:@{@"trackView": self.trackView, @"self": self}];
        NSArray *verticalConstraints = [NSLayoutConstraint constraintsWithVisualFormat:@"V:|-0-[trackView(self)]-0-|"
